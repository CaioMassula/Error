...
function preload()
{
  ...
  starOFF_img = loadImage('g_star1.png')
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   ballon.position(275,360);
   ballon.size(100,100);
   ballon.mouseClicked(airBallon);

   aniStar = createSprite(50,20,30,30);
   aniStar.scale = 0.2;
   aniStar.addAnimation('empty',emptyStar);
   aniStar.addAnimation('onestar',oneStar);
   aniStar.addAnimation('twostar',twoStar);
   aniStar.changeAnimation('empty');
 
  if (collide(fruit,star,20) == true){
    star.visible = false;
    aniStar.changeAnimation('onestar');
  }
  if (collide(fruit,star1,20) == true){
    star1.visible = false;
    aniStar.changeAnimation('twostar');
  }
  ...
  star = createSprite(310,50,20,20);
